...
#region Consts
const COLOR_1: Color = Color("#CDC1B4")
const COLOR_2: Color = Color("#EEE4DA")
const COLOR_3: Color = Color("#EDE0C8")
const COLOR_4: Color = Color("#F2B179")
const COLOR_5: Color = Color("#F59563")
const COLOR_6: Color = Color("#F67C5F")
const COLOR_7: Color = Color("#F65E3B")
const COLOR_8: Color = Color("#EDCF72")
const COLOR_9: Color = Color("#EDCC61")
const COLOR_10: Color = Color("#EDC850")
const COLOR_11: Color = Color("#EDC53F")
const COLOR_12: Color = Color("#EDC22E")
